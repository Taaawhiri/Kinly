      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.route_rounded, color: AppTheme.primary, size: 32),
          ),
          const SizedBox(height: 20),
          Text('Funzione Kinly+', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: AppTheme.textPrimary)),
