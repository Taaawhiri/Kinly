...
class _CreateCircleScreenState extends State<CreateCircleScreen> {
  ...
  Future<void> _create() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _error = AppLocalizations.of(context)!.circleLimitCirclesMessage;
          _limitReached = true;
        });
      }
    } catch (e) {
      if (mounted) setState(() => _error = AppLocalizations.of(context)!.createCircleError);
    } finally {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: _created == null ? _buildForm(context) : _buildSuccess(context, _created!),
        ),
      ),
    );
  }
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: l10n.createCircleNameField,
            filled: true,
        ...
        Text(l10n.createCircleIconLabel, style: TextStyle(fontWeight: FontWeight.w700, color: AppTheme.textPrimary)),
  ...
  Widget _buildSuccess(BuildContext context, CircleGroup circle) {
    final l10n = AppLocalizations.of(context)!;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        const SizedBox(height: 20),
        Text(l10n.createCircleSuccessTitle(circle.name), style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: AppTheme.textPrimary)),
        const SizedBox(height: 6),
        Text(
          l10n.createCircleSuccessMessage,
            ...
            children: [
              ...
              TextButton.icon(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(l10n.createCircleCodeCopied)));
                },
                icon: const Icon(Icons.copy_rounded, size: 16),
                label: Text(l10n.createCircleCopyCode),
              ),
            ],
          ),
        ),
